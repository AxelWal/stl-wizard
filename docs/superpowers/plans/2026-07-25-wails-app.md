...
The import path `../wailsjs/go/main/App` must match wherever the CLI put the generated bindings — you recorded that in Task 5. Correct it if it differs.
...
import { Select } from "../wailsjs/go/main/App";
...
```js
import { Cut, Undo, ExportAll } from "../wailsjs/go/main/App";
